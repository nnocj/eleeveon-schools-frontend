 ...
 * - shows the supplied academic level and academic period inside the transcript info grid
 * - continues to rely on the parent cumulative report page/engine for header context
 * - no styling, fetching, computation or print layout behavior changed
 */
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          >
            ...
            <div style={infoBox}>
              <div style={label}>Academic Level</div>
              <div style={value}>{header.academicStructure?.name || "-"}</div>
            </div>
        ...
        <div style={{ overflowX: "auto" }}>
          <table style={table}>
            <thead>
              <tr>
                <th style={th}>#</th>
                <th style={th}>Academic Structure</th>
