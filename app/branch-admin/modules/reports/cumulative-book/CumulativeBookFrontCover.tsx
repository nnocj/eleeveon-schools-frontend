...
export default function CumulativeBookFrontCover({
  ...
  return (
    <section
      className="print-page cumulative-book-page cumulative-book-front-cover"
      style={page}
    >
      <div
        aria-hidden="true"
        style={{
          ...
          border:
            tone === "premium"
              ? `2px double ${primary}`
              : `1px solid ${tone === "montessori" ? "#c8bda8" : "#d1d5db"}`,
          ...
          <div style={{ width: "86%", maxWidth: 560 }}>
            ...
            <h1
              style={{
                ...
                textTransform:
                  tone === "kindergarten" || tone === "montessori"
                    ? "none"
                    : "uppercase",
            ...
            <div
              style={{
                ...
                borderRadius: tone === "transcript" ? 0 : 18,
                background:
                  tone === "transcript" ? "#fff" : "rgba(255,255,255,.78)",
              }}
            >
              <div
                style={{
        ...
        >
          <span>
            {branding.address ||
              branding.email ||
              branding.website ||
              "Official school academic record"}
          </span>
          {generated && (
            <span>
              {settings?.generatedDateLabel || "Generated"}: {generated}
            </span>
          )}
        </div>
      </div>
