  ...
  [
    {
      ...
      description:
        "Formal school-friendly cumulative transcript with period-by-period academic records.",
      reportType: "cumulative_transcript",
    ...
    },
    {
      ...
      description:
        "Registrar-style official academic records layout inspired by university transcript structure.",
      reportType: "cumulative_transcript",
      orientation: "portrait",
      paperSize: "A4",
      density: "compact",
    ...
    },
    {
      ...
      description:
        "Clean modern cumulative transcript with summary metrics and readable period cards.",
      reportType: "cumulative_transcript",
      orientation: "portrait",
      paperSize: "A4",
      density: "comfortable",
    ...
    },
    {
      ...
      description:
        "Print-efficient dense transcript for schools that need to save paper.",
      reportType: "cumulative_transcript",
      orientation: "portrait",
      paperSize: "A4",
      density: "compact",
...
export function getCumulativeTranscriptTemplateRegistryItem(
  codeOrLayoutKey?: string | null,
) {
...
export function resolveCumulativeTranscriptTemplateComponent(
  codeOrLayoutKey?: string | null,
) {
