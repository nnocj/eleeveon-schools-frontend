...
export default function CambridgeTemplate({
  ...
  const reportPage = (
    ...
    >
      ...
      <div aria-hidden="true" className="cambridge-frame-line cambridge-frame-outer" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="cambridge-frame-line cambridge-frame-inner" />
      <div aria-hidden="true" className="cambridge-corner cambridge-corner-tl" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="cambridge-corner cambridge-corner-tr" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="cambridge-corner cambridge-corner-bl" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="cambridge-corner cambridge-corner-br" style={{ borderColor: primary }} />
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <div style={{ marginTop: 8 }}>
          <table style={tableStyles.table}>
            <thead>
              <tr>
                <th data-report-color-block="true" style={{ ...tableStyles.th, textAlign: "left", minWidth: 98 }}>Subject / Course</th>
                ...
                <tr key={subject.classSubjectId}>
                  ...
                  {resolvedSettings.showGrade && (
                    <td style={{ ...tableStyles.td, textAlign: "center" }}>
                      <span className="cambridge-grade-pill" style={{ borderColor: primary, color: primary }}>{subject.grade}</span>
                    </td>
                  )}
                  {resolvedSettings.showSubjectPosition && (
          ...
          >
            ...
            {currentPeriodEndLine && nextPeriodLine && (
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                <span className="cambridge-timeline-marker" style={{ borderColor: primary }} />
              </div>
            )}
