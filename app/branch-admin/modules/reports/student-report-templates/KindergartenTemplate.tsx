      ...
      <div style={{ position: "relative", zIndex: 1 }}>
          ...
          {resolvedSettings.showStudentPhoto && (
            ...
            >
              {studentPhoto ? (
                ...
                <span style={{ fontSize: 9, fontWeight: 950, color: "#78716c" }}>PHOTO</span>
              )}
            </div>
          )}
        </section>
        ...
        <div style={{ marginTop: 8 }}>
          <table style={tableStyles.table}>
            <thead>
              <tr>
                <th data-report-color-block="true" style={{ ...tableStyles.th, textAlign: "left", minWidth: 98 }}>Learning Area / Learning Area</th>
                ...
                <tr key={subject.classSubjectId}>
                  ...
                  {resolvedSettings.showGrade && (
                    <td style={{ ...tableStyles.td, textAlign: "center" }}>
                      <span className="kindergarten-grade-badge" style={{ borderColor: primary, color: primary }}>{subject.grade}</span>
                    </td>
                  )}
                  {resolvedSettings.showSubjectPosition && (
          ...
          >
            ...
            {summaryCards.map((card, index) => (
              ...
              >
                ...
                <div style={{ marginTop: 2, fontSize: compact ? 14 : 15.8, fontWeight: 950, color: "#1f2937" }}>
                  {card.value}
                </div>
              </div>
            ))}
