...
export default function LetterHeadPremiumTemplate({
  ...
  const reportPage = (
    ...
    >
      ...
      <div aria-hidden="true" className="letterhead-frame-line letterhead-frame-outer" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="letterhead-frame-line letterhead-frame-inner" />
      <div aria-hidden="true" className="letterhead-corner letterhead-corner-tl" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="letterhead-corner letterhead-corner-tr" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="letterhead-corner letterhead-corner-bl" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="letterhead-corner letterhead-corner-br" style={{ borderColor: primary }} />
                ...
                <tr key={subject.classSubjectId}>
                  ...
                  {resolvedSettings.showGrade && (
                    <td style={{ ...tableStyles.td, textAlign: "center" }}>
                      <span className="letterhead-grade-seal" style={{ borderColor: primary, color: primary }}>{subject.grade}</span>
                    </td>
                  )}
                  {resolvedSettings.showSubjectPosition && (
          ...
          >
            ...
            {currentPeriodEndLine && nextPeriodLine && (
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                <span className="letterhead-timeline-medallion" style={{ borderColor: primary }} />
              </div>
            )}
