...
export default function ModernCleanTemplate({
  ...
  const reportPage = (
    ...
    >
      ...
      <div aria-hidden="true" className="modern-frame-line modern-frame-outer" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="modern-frame-line modern-frame-inner" />
      <div aria-hidden="true" className="modern-corner modern-corner-tl" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="modern-corner modern-corner-tr" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="modern-corner modern-corner-bl" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="modern-corner modern-corner-br" style={{ borderColor: primary }} />
                ...
                <tr key={subject.classSubjectId}>
                  ...
                  {resolvedSettings.showGrade && (
                    <td style={{ ...tableStyles.td, textAlign: "center" }}>
                      <span className="modern-grade-pill" style={{ borderColor: primary, color: primary }}>{subject.grade}</span>
                    </td>
                  )}
                  {resolvedSettings.showSubjectPosition && (
          ...
          >
            ...
            {currentPeriodEndLine && nextPeriodLine && (
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                <span className="modern-timeline-dot" style={{ borderColor: primary }} />
              </div>
            )}
