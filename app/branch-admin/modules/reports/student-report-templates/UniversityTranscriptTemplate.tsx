...
export default function UniversityTranscriptTemplate({
  ...
  const reportPage = (
    ...
    >
      ...
      <div aria-hidden="true" className="university-transcript-frame-line university-transcript-frame-outer" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="university-transcript-frame-line university-transcript-frame-inner" />
      <div aria-hidden="true" className="university-transcript-corner university-transcript-corner-tl" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="university-transcript-corner university-transcript-corner-tr" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="university-transcript-corner university-transcript-corner-bl" style={{ borderColor: primary }} />
      <div aria-hidden="true" className="university-transcript-corner university-transcript-corner-br" style={{ borderColor: primary }} />
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
          ...
          {resolvedSettings.showStudentPhoto && (
            ...
            >
              {studentPhoto ? (
                ...
                <span style={{ fontSize: 9, fontWeight: 950, color: "#4b5563" }}>PHOTO</span>
              )}
            </div>
          )}
        </section>
        ...
        <div style={{ marginTop: 8 }}>
          <table style={tableStyles.table}>
            <thead>
              <tr>
                <th data-report-color-block="true" style={{ ...tableStyles.th, textAlign: "left", minWidth: 98 }}>Course / Subject</th>
                ...
                <th data-report-color-block="true" style={tableStyles.th}>Final Score</th>
                ...
                <tr key={subject.classSubjectId}>
                  ...
                  {resolvedSettings.showGrade && (
                    <td style={{ ...tableStyles.td, textAlign: "center" }}>
                      <span className="university-transcript-grade-badge" style={{ borderColor: primary, color: primary }}>{subject.grade}</span>
                    </td>
                  )}
                  {resolvedSettings.showSubjectPosition && (
              ...
              {!report.subjectResults.length && (
                <tr>
                  <td style={{ ...tableStyles.td, textAlign: "center", padding: 16 }} colSpan={subjectTableColumnCount}>
                    No course / subject records available for this selected period.
                  </td>
                </tr>
              )}
            </tbody>
          ...
          >
            ...
            {summaryCards.map((card, index) => (
              ...
              >
                ...
                <div style={{ marginTop: 2, fontSize: compact ? 14 : 15.8, fontWeight: 950, color: "#111827" }}>
                  {card.value}
                </div>
              </div>
            ))}
          ...
          >
            ...
            {currentPeriodEndLine && nextPeriodLine && (
              <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                <span className="university-transcript-timeline-marker" style={{ borderColor: primary }} />
              </div>
            )}
